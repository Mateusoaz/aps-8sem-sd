...
for indice in range(args.amostras):
    ...
    request = Request(f"http://localhost:3003/api/v1/sensores/{sensor}/eventos", data=json.dumps(payload, ensure_ascii=False).encode(), method="POST", headers={"Content-Type": "application/json", "X-Source-Id": sensor})
