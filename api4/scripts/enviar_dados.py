...
JSON_FILE, DB_FILE = ROOT / "jsons" / "inversao_termica.json", ROOT / "data" / "inversao_termica.db"
SUFFIX = "leituras"
...
def main():
    ...
    for indice in range(args.amostras):
        ...
        request = Request(f"http://localhost:3004/api/v1/sensores/{sensor}/{SUFFIX}", data=body, method="POST", headers={"Content-Type":"application/json", "X-Source-Id":sensor})
