"""Envia novas leituras do sensor de alagamento e mede cada POST."""
...
JSON_FILE = ROOT / "jsons" / "alagamento_inundacao.json"
SUFFIX = "ocorrencias"
...
def main():
    ...
    with urlopen("http://127.0.0.1:3002/api/v1/ocorrencias?limite=1", timeout=5) as response:
        print("Última ocorrência persistida:", response.read().decode())
